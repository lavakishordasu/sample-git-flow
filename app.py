...
# this line not required hello
app = Flask(__name__)
app.config['SECRET_KEY'] = 'db6c5f48d778e4d356f7234a002bb0acbb41dee209bec32c6f918b70ff2d20b9'
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:12345@localhost/Resource'
app.config['MAIL_SERVER'] = 'smtp.gmail.com'
app.config['MAIL_PORT'] = 587
app.config['MAIL_USE_TLS'] = True
app.config['MAIL_USERNAME'] = 'nareesh.are@randstaddigital.com'
app.config['MAIL_PASSWORD'] = 'wowx jrwt fgfx hdhf'
db = SQLAlchemy(app)
mail = Mail(app)
